...
/*fn rand_vec_in_unit_sphere(rng: &mut ThreadRng) -> vector3d {
    vector3d::new(
...
/*fn diffuse_ray_direction(record: &HitRecord, rng: &mut ThreadRng) -> RayReturnState {
...
impl Material for NormalMaterial {
    fn get_next_ray_dir(
        &self,
        _record: &HitRecord, /*, _rng: &mut ThreadRng*/
    ) -> RayReturnState {
        RayReturnState::Stop
    }
